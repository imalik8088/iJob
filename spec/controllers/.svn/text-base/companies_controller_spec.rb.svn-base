...
describe CompaniesController do
  ...
  it "should find a Job by ID" do
    comp = Company.new(:name => "hda", :city => "Darm")
    comp.save.should be_true
    Company.first.id.should == 1
    job1 = Job.new(:title => "JobTitle", :company_id => 1)
    job2 = Job.new(:title => "EwaM", :company_id => 1)
    job1.save.should be_true
    job2.save.should be_true
    
    get :show, :id => 1

    assigns(:company).should == Company.first
  end
